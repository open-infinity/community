...
<head>
  ...
  <link rel="stylesheet" href="<spring:url value="/resources/styles.css" />" type="text/css"/>
  <link rel="stylesheet" href="<spring:url value="/resources/thickbox.css" />" type="text/css"/>
  <script type="text/javascript" src="<c:url value="/resources/jquery.min.js" />"></script>
  <script type="text/javascript" src="<c:url value="/resources/json.min.js" />"></script>
  <title>Open Infinity - Show Case</title>  
</head>
<body>
		...
		<div class="container">
			...
			<div id="content">
				<div id="menu" class="menu"> 
					...
					<a href="<spring:url value="/catalogue" htmlEscape="true" />" class="menu"><b>Catalogue</b></a> |
