// Generated by delombok at Wed May 15 14:10:02 EEST 2013
/*
...
//	}
	...
	@java.lang.SuppressWarnings("all")
	public void setCatalogue(final Catalogue catalogue) {
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (this.getCatalogue() == null ? other.getCatalogue() != null : !this.getCatalogue().equals((java.lang.Object)other.getCatalogue())) return false;
		return true;
	}
	...
	public int hashCode() {
		...
		result = result * PRIME + (this.getCatalogue() == null ? 0 : this.getCatalogue().hashCode());
		return result;
	}
	...
	public java.lang.String toString() {
		return "Product(id=" + this.getId() + ", name=" + this.getName() + ", company=" + this.getCompany() + ", description=" + this.getDescription() + ", price=" + this.getPrice() + ", catalogue=" + this.getCatalogue() + ")";
	}
